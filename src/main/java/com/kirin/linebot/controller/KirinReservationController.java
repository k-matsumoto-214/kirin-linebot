...
public class KirinReservationController {
  ...
  private static final DateTimeFormatter DTF_TO_STRING = DateTimeFormatter.ofPattern(
      "yyyy年MM月dd日");
  ...
  public void handlePostbackEvent(PostbackEvent event)
    ...
    // 予約種別情報を取得
    ReservationTypeDto dto = objectMapper.readValue(reservationTypeString,
        ReservationTypeDto.class);
    ...
    // DBに登録済みか確認する
    ReservationDate reservationDate = reservationService.findReservationTarget(targeDate,
        reservationType);
